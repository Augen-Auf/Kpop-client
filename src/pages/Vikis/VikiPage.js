...
const VikiPage = () => {
    ...
    return (
        <div className="flex justify-center font-montserrat font-normal py-10">
            {viki &&
            <div className="flex flex-col md:w-1/2 md:px-0 px-5 h-3/5 space-y-5 items-center">
                <div className="bg-pink p-5 rounded-md flex space-x-5 justify-center w-min">
                    ...
                    <div className="h-52 flex flex-col justify-center space-y-3">
